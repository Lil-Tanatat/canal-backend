...
const CONDITION_COLOR = { New: "#16a34a", Used: "#d97706", Damaged: "#dc2626", "": "#94a3b8" };
const CONDITION_BG    = { New: "#dcfce7", Used: "#fef3c7", Damaged: "#fee2e2", "": "#f1f5f9" };
    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12, marginBottom: 20 }}>
        {[
          ...
          { key: "Used",    label: "เคยใช้แล้ว",  icon: "🔄" },
                  ...
                  <tr key={item.ID + idx} style={{
                    ...
                    <td style={{ padding: "12px 14px" }}>
                      <div style={{ display: "flex", flexDirection: "column", gap: 3, fontSize: 12 }}>
                        ...
                        {(parseInt(item.qty_used) || 0) > 0 && <span style={{ color: "#d97706", fontWeight: 600 }}>🔄 ใช้แล้ว {item.qty_used}</span>}
