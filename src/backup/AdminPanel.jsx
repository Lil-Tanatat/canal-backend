      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0 16px" }}>
        ...
        <Field label="ความเร่งด่วน">
          <Select value={form.urgency} onChange={e => set("urgency", e.target.value)}
            options={[{ value: "low", label: "🟢 ไม่ด่วน" }, { value: "medium", label: "🟡 ด่วนปกติ" }, { value: "high", label: "🔴 เร่งด่วน" }]} />
        </Field>
      ...
      <div style={{ marginTop: 28 }}>
        ...
        <ItemTable items={items} loading={loadingItems}
          columns={[
            ...
            { key: "urgency", label: "ความด่วน", render: i => ({ high: "🔴 เร่งด่วน", medium: "🟡 ด่วนปกติ", low: "🟢 ไม่ด่วน" }[i.urgency] || "—") },
